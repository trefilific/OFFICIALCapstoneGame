...
public class EnemyAi : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (player == null)
        {
            ...
            {
                Debug.LogError("EnemyAi: No GameObject with name 'Player' found in the scene.");
            }
        }
        ...
        if (animator == null)
        {
            ...
            if (animator == null)
            {
                Debug.LogWarning("EnemyAi: No Animator found on this GameObject or its children.");
            }
        }
    }
    ...
    private void FireProjectile()
    {
        ...
        if (projectileRb != null)
        {
            ...
            projectileRb.AddForce(firepoint.up * verticalShotForce, ForceMode.Impulse);
            Destroy(projectileRb.gameObject, 3f);
        }
    }
    ...
    private void UpdateAnimator()
    {
        ...
        bool isMoving = agent.velocity.magnitude > 0.1f && !isPlayerInRange;
